...
final public class PTabUICmdKtlKstOpenCrKprV3CEc extends PTabUICmdKtlKstOpenCrKprV3CAbs 
{        
    // ---------------------------
    // final static private String
    
    final static public String STR_TITLETASK = "Create EC private key entry, with vers. #3 cert";
    ...
    public PTabUICmdKtlKstOpenCrKprV3CEc(Frame frmOwner, String strTitleAppli)
    {
        super(
            PTabUICmdKtlKstOpenCrKprV3CEc._s_strHelpID, 
            frmOwner, 
            strTitleAppli,
            KTLAbs.s_getItgsListSizeKprEc(),
