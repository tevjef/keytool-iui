...
final public class PSelBtnTfdFileSaveCrt extends PSelBtnTfdFileSaveAbs
{   
    // -------------------
    // FINAL STATIC PUBLIC
    
    final static public String f_s_strDocPropVal = "select_file_crt_save";
    final static public String s_strDirNameDefault = "mycrts";      // !!! already defined
    final static public String f_s_strLabel = "Certificate file:"; // !!! already defined
        ...
        )
    {
        super(
            ...
            frmParent, 
            strTitleAppli, 
            PSelBtnTfdFileSaveCrt.f_s_strLabel,
        ...
        super._tfdCurSelection_.getDocument().putProperty(
            ...
            (Object) PSelBtnTfdFileSaveCrt.f_s_strDocPropVal);
    ...
    protected void _showDialog_()
    {
        ...
        fle = S_FileChooserUI.s_getSaveFile(
            ...
            strsTypeFileCrtCur, 
            strFileDesc,
            S_FileExtensionUI.f_s_strDirNameDefaultCrt);
    ...
    **/
    private boolean _addGroup()
    {
        ...
        if (this._btnTypeFileCrtPkcs7Prt==null || this._btnTypeFileCrtPkcs7==null || this._btnTypeFileCrtDer==null)
        {
