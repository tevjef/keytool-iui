...
final public class PTabUICmdKtlKstOpenCryptEncShk extends PTabUICmdKtlKstOpenCryptEncAbs
{
    // ---------------------------
    // final static private String
    
    final static public String STR_TITLETASK = "Encrypt data file with secret key entry & save as file";
    ...
    public PTabUICmdKtlKstOpenCryptEncShk(Frame frmOwner, String strTitleAppli)
    {
        super(
            frmOwner, 
            strTitleAppli,
