...
final public class PSelBtnTfdFileOpenSig extends PSelBtnTfdFileOpenAbs
{   
    // -------------------
    // FINAL STATIC PUBLIC
    
    final static public String f_s_strDocPropVal = "select_file_sig_open";
    ...
    protected void _showDialog_()
    {
        ...
        File fle = S_FileChooserUI.s_getOpenFile(
            ...
            strsTypeFileSigCur, 
            strFileDesc,
            S_FileExtensionUI.f_s_strDirNameDefaultSig);
